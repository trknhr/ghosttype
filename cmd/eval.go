...
func RunEvaluation(model entity.SuggestModel, filePath string) error {
...
func printEvaluationResults(model entity.SuggestModel, result EvaluationResult) {
...
func printSuggestionList(suggestions []entity.Suggestion) {
...
func NewEvalCmd(db *sql.DB) *cobra.Command {
  ...
  ghosttype eval -f eval_data.jsonl -m markov`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			return RunEvaluation(pmodel, evalFile)
		},
	}
